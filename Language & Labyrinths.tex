...
\subsection{Analytic Archipelago}
     The scattered islands of the Analytic Archipelago are home to 

%%     
%%\subsection{On Structure and Syntax}
%%\DndDropCapLine{L}{et us delve into the analytical.} 
%%\subsubsection{Sign and Symbol}
